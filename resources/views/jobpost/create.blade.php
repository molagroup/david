						    ...
						    <select class="form-control" id="jobcategory" name="category_id">
						    	<option selected disabled value="0">...Select Job Category</option>
			                        {{-- @foreach ($categories as $category)
										...
										<option value="part-time">Programming</option>
			                   			<option value="full-time">Cloud</option>
										<option value="part-time">Business Support</option>
			                   			<option value="full-time">Graphic Design</option>  
										<option value="part-time">Web Design</option>
			                   			<option value="full-time">Technical Director</option> --}}   
			                        {{-- @endforeach --}}
						    </select>
						    </div>
					  </div>
