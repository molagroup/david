            ...
            <div class="card card-default">  
                ...
                <div class="card-body pt-0 table-responsive py-3">
                	<div class="row">
                        ...
                        {{-- <div><a href="">(($applicant->resume))</a></div> --}}
                		...
                		<div class="col-sm-4">
                			 <ul class="list-unstyled">
                                    ...
                                    <li class="mb-2">
                                     ...
                                     @else
                                        <li>
                                        <a href="{{url('/download', $applicant->resume)}}" class="btn btn-info w-100 mb-2">Download Resume</a>
                                        </li>
                                        <li>
                                        <a href="{{$applicant->id}}/hire" class="btn btn-success w-100 mb-2">INTERVIEW</a>
                                        </li>
                                        <li>
