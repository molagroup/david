...
<html lang="en">
  <head>
    <title> Molaprise &mdash; Jobs</title>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-6 text-center" data-aos="fade">
            ...
            <p><a href="/register" class="btn btn-outline-success py-3 px-4">Job seeker</a> <a href="{{route('employer.register')}}" class="btn btn-outline-warning py-3 px-4"> Molaprise </a></p>
